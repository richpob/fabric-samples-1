...
infoln "Joining iebs peer to the channel..."
joinChannel 1
infoln "Joining cantabria peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for iebs..."
setAnchorPeer 1
infoln "Setting anchor peer for cantabria..."
setAnchorPeer 2
